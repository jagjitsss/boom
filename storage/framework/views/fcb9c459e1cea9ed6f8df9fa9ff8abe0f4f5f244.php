...
<link rel="stylesheet" href="<?php echo e(asset('/').('public/assets/css/marquee.css')); ?>">
<link href="<?php echo e(asset('/').('public/assets/css/aos-animation-style.css')); ?>" rel="stylesheet">
...
<div class="loader-bg" id="load">
  <div class="loader"> <img src="<?php echo e(asset('/').('public/assets/images/')); ?>loader.gif" ></div>
</div>
<div class="api-page-header">
  <div class="container">
    <nav class="navbar navbar-expand-md justify-content-center index-header fixed-top navbar-fixed-top apitopbox"> <a class="navbar-brand" href="<?php echo Config::get('domain.url'); ?>"> <img src="<?php echo e($site->site_logo); ?>"class="img-fluid"> </a>
      ...
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav flex-row justify-content-center flex-nowrap right-nav-links">
            ...
            <li class="nav-item"> <a class="nav-link <?php echo $page == 1 ? 'active' : ' ' ?>" href="<?php echo url('dashboard'); ?>" id="overview-link"> <?php echo e(trans('app_lang.overview')); ?></a> </li>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item"> <a class="nav-link <?php echo $page == 8 ? 'active' : ' ' ?>" href="<?php echo url('api/api_document'); ?>" id="overview-link"> <?php echo e(trans('app_lang.api')); ?></a> </li>
            <li class="nav-item"> <a class="nav-link <?php echo $page == 3 ? 'active' : ' ' ?>" href="<?php echo url('funds'); ?>" id="funds-link"><?php echo e(trans('app_lang.funds')); ?></a> </li>
            <li class="nav-item"> <a class="nav-link <?php echo $page == 4 ? 'active' : ' ' ?>"  href="<?php echo url('referral'); ?>" id="referals-link"><?php echo e(trans('app_lang.refer')); ?></a> </li>
            
            <li class="nav-item"> <a class="nav-link <?php echo $page == 6 ? 'active' : ' ' ?>" href="<?php echo url('support'); ?>" id=""><?php echo e(trans('app_lang.support')); ?></a> </li>
            <li class="nav-item"> <a class="nav-link <?php echo $page == 7 ? 'active' : ' ' ?>" href="<?php echo url('bankwire'); ?>" id=""><?php echo e(trans('app_lang.bankwire')); ?></a> </li>
            <?php } else { ?>
           
    
            <li class="nav-item"> <a class="nav-link <?php echo $page == 2 ? 'active' : ' ' ?>" href="<?php echo e(url('trade')); ?>" id="funds-link">
              <div class="tab-link-txt"><?php echo e(trans('app_lang.exchange')); ?></div>
              </a> </li>
            <li class="nav-item"> <a class="nav-link <?php echo $page == 8 ? 'active' : ' ' ?>" href="<?php echo url('dashboard'); ?>" id="overview-link"><?php echo e(trans('app_lang.api')); ?></a> </li>
            <?php } ?>
            ...
            <li class="nav-item dashboard-header-links dash-header-icon-link">
              <div class="dropdown"> <a href="<?php echo e(url('/notification_list')); ?>" onclick="view_notf('<?php echo $p; ?>')">
            ...
            <?php } else { ?>
            <li class="nav-item"> <a class="nav-link index-header-link" href="<?php echo url('login'); ?>"><?php echo e(trans('app_lang.login')); ?></a> </li>
            <li class="nav-item"> <a class="nav-link index-header-link nav-register" href="<?php echo url('register'); ?>"><?php echo e(trans('app_lang.signup')); ?></a> </li>
...
<script src="<?php echo e(asset('/').('public/assets/js/aos-animation-script.js')); ?>"></script> 
...
<script src="<?php echo e(asset('/').('geetest/gt3-php-sdk-master/static/gt.js?ver=123')); ?>"></script> 
...
<script src="<?php echo e(asset('/').('public/assets/js/common_script.js')); ?>?<?php echo e(date('y-m-d h:i')); ?>"></script> 
<script type="text/javascript">
...
<script src="<?php echo e(asset('/').('public/assets/js/jquery.scrollbox.js')); ?>"></script> 
<script>
...
function search_filter(val)
{
	if(val == 1){
	 ...
	 window.location.replace("<?php echo e(URL::to('/news')); ?>"+page);
...
function front_back(val){
   ...
   window.location.replace("<?php echo e(URL::to('/news')); ?>"+'?page='+form);
}
...
<script>
	...
	var picurl= "<?php echo e(asset('/').('public/images/admin_currency/')); ?>";
