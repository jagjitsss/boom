...
<div class="header-section">
  <div class="container-fluid reg_page index-navigation">
    <div class="login-page regis-form" data-aos="fade-up" data-aos-duration="800">
      <div class="form">
        <?php echo Form::open(array('class'=>'register-form', 'id'=>'register','url'=>'register','method'=>'POST','onsubmit'=>'signup_load()')); ?>

          <div class="log_new_class">
            <h2 class="form-heading"><?php echo e(trans('app_lang.register')); ?></h2>
          </div>
           <div class="log_new">
          <input type="email" name="email" id="email" class="email white-space-is-dead" placeholder="<?php echo e(trans('app_lang.email_address')); ?>" required />
          <span class="el-input__prefix"><i class="fa fa-envelope" aria-hidden="true"></i></span>
        </div>
        <div class="log_new">
          <input type="password" name="password" id="password"  placeholder="<?php echo e(trans('app_lang.password')); ?>" required />
          <span class="el-input__prefix"><i class="fa fa-lock"></i></span>
        </div>
          <div class="log_new">
          <input type="password" name="password_confirmation" id="cpassword"  placeholder="<?php echo e(trans('app_lang.confirm_password')); ?>" required />
          <span class="el-input__prefix"><i class="fa fa-lock"></i></span>
        </div>
        <div class="log_new">
          ...
          <input type="text" name="mobileno" id="mobileno" placeholder="<?php echo e(trans('app_lang.mobileno')); ?>" onkeypress="return isNumberKey(event)" required />
      ...
      <div class="log_new">
          <input type="hidden" value="<?php echo $refid;?>" name="refer_id" placeholder="<?php echo e(trans('app_lang.referal_code')); ?>"/>
          </div>
...
<div class="mb-10 capcha">
    ...
    <label for="hidden-grecaptcha" class="error"></label>
          ...
          <button type="submit" id="embed-submit" class="signup_sub"><?php echo e(trans('app_lang.signup')); ?></button>
  <p class="message right-message"><?php echo e(trans('app_lang.already_registered')); ?>?  <a href="<?php echo url('login'); ?>"><?php echo e(trans('app_lang.login')); ?></a></p>
...
<script>
  ...
  var email_exist_reg ="<?php echo e(trans('app_lang.email_exist')); ?>"; 
  var require_field_reg ="<?php echo e(trans('app_lang.field_require')); ?>";
  var pwd_min_reg ="<?php echo e(trans('app_lang.min_8_char')); ?>";
  var check_pwd_reg ="<?php echo e(trans('app_lang.min_8_char_validate')); ?>";
  var same_pwd_reg ="<?php echo e(trans('app_lang.enter_same_password')); ?>";
  var gcapcha = 'reg';
  var signup = "<?php echo e(trans('app_lang.signup')); ?>";
  var otp_wrong = "<?php echo e(trans('app_lang.otp_wrong')); ?>";
  var sendotp = "<?php echo e(trans('app_lang.sendotp')); ?>";
  var otp_require = "<?php echo e(trans('app_lang.otp_require')); ?>";
