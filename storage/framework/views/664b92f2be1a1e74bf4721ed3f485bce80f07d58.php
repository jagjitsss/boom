<div class="dropdown-menu dropdown-menu1 dd-table-cnt">
		<div class="dd-table">
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link tab-pane-trade tet" data-toggle="tab" data-target="#dd-trade-fav1" href="javascript:;"><?php echo e(trans('app_lang.favorite')); ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link active tab-pane-trade tet" data-toggle="tab" data-target="#dd-trade-btc1" href="javascript:;">BTC</a>
				</li>
			
				<input type="text" placeholder="<?php echo e(trans('app_lang.search')); ?>" class="adv_mob_search portlet-header-search">
			</ul>
