    ...
    <div class="col-xs-12 col-sm-12 col-md-11 tab-content"> 
      <div class="tab-pane container-fluid active no-padding" id="overview">
        <div class="inner_banner">
          <?php echo $__env->make('front.common.titlebarmenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
          ...
          <div class="col-md-12 col-sm-6 col-lg-6 wow fadeInLeft">
            <div class="ms-l">
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <div>
                    <div class="banner-under-boompay2">
                      ...
                      <?php echo Form::open(array('id'=>'buy_exchange','url'=>'makeexchange','class'=>'my-5','form_style_1','method'=>'POST')); ?>
                      ...
                      <div class="row justify-content-center d-flex bub2">
                        ...
                        ?>
                            ...
                            <div class="col-md-3">
                              <label for="ksad_<?php echo e($i); ?>">
                              <div id="selectnew_<?php echo e($i); ?>" style="<?php echo e($style); ?>" class="boompay-box2 text-center currencyselectedlist">
                                <div class="text-center">
                                  <?php if($image): ?>
                                    <img class="img-fluid" src="<?php echo e(url('public/assets/images/'.$image)); ?>" alt="">
                                  <?php endif; ?>
                                </div>
                                <div>
                                  <h3><?php echo e($name); ?></h3>
                                    <p class="last-price-box">
                                        <span id="selected_box_currency_amt_<?php echo e($value->symbol); ?>">
                                          <?php echo number_format($value->inr_value, 8, '.',''); ?>
                                        </span>
                                        <span class="selected_box_currency"> USD</span>
                                    </p>
                                  <p><input <?php echo e($checked); ?> id="ksad_<?php echo e($i); ?>" data-id="<?php echo e($i); ?>" type="radio" name="select_to_currency" class="select_to_currency" value="<?php echo e($value->symbol); ?>" style="position: inherit!important;" /></p>
              ...
              <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div>
                <div class="banner-under-boompay2">
                   <?php echo Form::open(array('id'=>'sell_exchange','url'=>'makeexchange','class'=>'my-5','form_style_1','method'=>'POST')); ?>
                      ...
                      <div class="row justify-content-center d-flex bub2">
                        ...
                        ?>
                            ...
                            <div class="col-md-3">
                              <label for="ksadsell_<?php echo e($i); ?>">
                              <div id="selectsell_<?php echo e($i); ?>" style="<?php echo e($style); ?>" class="boompay-box2 text-center currencyselectedlistsell">
                                <div class="text-center">
                                  <?php if($image): ?>
                                            <img class="img-fluid" src="<?php echo e(url('public/assets/images/'.$image)); ?>" alt="">
                                          <?php endif; ?>
                                ...
                                <div>
                                  ...
                                  <p class="last-price-box">
                                    ...
                                    <span id="sell_selected_box_currency_amt_<?php echo e($value->symbol); ?>">
                                          <?php echo number_format($value->inr_value, 8, '.',''); ?>
                                        </span>
                                        <span class="sell_selected_box_currency"> USD</span>
                                      
                                    </p>
                                  <p><input <?php echo e($checked); ?> id="ksadsell_<?php echo e($i); ?>" data-id="<?php echo e($i); ?>" type="radio" name="select_to_currency" class="select_to_currency_sell" value="<?php echo e($value->symbol); ?>" style="position: inherit!important;" /></p>
            ...
            <div class="col-md-12 col-sm-6 col-lg-6 wow fadeInLeft">
              <div class="buying-btc-box">
                ...
                <h5 class="font14"> <span id="perpriceusdvalue"><?php echo e(getUsd()); ?></span> <span id="perpriceusdvaluesymbol">USD</span> per <span id="perpricesymbol">BTC</h5>
...
<script type="text/javascript">
  ...
  const formatter = new Intl.NumberFormat('en-US', {
   ...
   var last_price = parseFloat("<?php echo e(getUsd()); ?>");
    ...
    submitHandler:function()
    {
      ...
      $.ajax({
        ...
        error:function(data,status,xhr) {
          ...
          {
            notif({ msg: '<img src="<?php echo e(asset("/").("public/frontend/img/error_notify.png")); ?>"/>'+" Too Many Requests!", type: "error" });

          }
          else
          {
            notif({ msg: '<img src="<?php echo e(asset("/").("public/frontend/img/error_notify.png")); ?>"/>'+" Error encountered!", type: "error" });
          }
 ...
 $("#triggerdepositex_payout").click(function()
 {
  ...
  $('#accept').click(function()
  {
    ...
    if(action == 'buy') {
      ...
      $.ajax({
        type:'POST',
        url: "<?php echo e(URL::to('makeexchange')); ?>",
        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
        data: dataform,
        async: false,
  ...
  $(document).ready(function(){
    ...
    "ajax": {
      "url": "<?php echo e(URL('exchangeHistory')); ?>",
      "data": function ( d ) {
  ...
  function syncTransactionProcess(transactionUniqueID){
      ...
      $.ajax({
        type:'POST',
        url: "<?php echo e(URL::to('getTransactionSync')); ?>",
        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
   ...
   function syncTransactionProcessPayout(transactionUniqueID){
      ...
      $.ajax({
        type:'POST',
        url: "<?php echo e(URL::to('getPayoutTransactionSync')); ?>",
        headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        data:{transactionUniqueID : transactionUniqueID},
        beforeSend:function(output)
        {
