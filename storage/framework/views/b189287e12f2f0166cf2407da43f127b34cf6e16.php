                ...
                <div class="container">
                    <div class="row pt-40 pb-40">
                        <div class="col-lg-6 col-12 api-docs-left">
                            <h2 class="title"><?php echo e(trans('app_lang.api_heading')); ?></h2>
                          
      <p><?php echo e(trans('app_lang.api_content')); ?></p> <br>     
                            <h4 class="h4"><?php echo e(trans('app_lang.api_heading2')); ?></h4>
                            <p><?php echo e(trans('app_lang.api_content2')); ?></p>
                            <p><p style="width: 65%;" class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2"><?php echo e(URL::to('/api')); ?></p>
                            </p>
                            <p><?php echo e(trans('app_lang.api_content3')); ?></p>
                        </div>
                        <div class="col-lg-6 col-12 api-docs-right">
                            
                            <img src="<?php echo e($banner->image_url); ?>" alt="API Docs">
                    ...
                    <div class="row pb-40">
                        <div class="col-lg-12 col-12">
                            <h4 class="h4"><?php echo e(trans('app_lang.api_heading3')); ?></h4>
                                <p><?php echo e(trans('app_lang.api_content4')); ?></p>
                                                        <p><?php echo e(trans('app_lang.api_example')); ?></p>
                            <div class="api-list">
                                <pre><code># <?php echo e(trans('app_lang.api_example1')); ?>

                                curl "<a href="<?php echo e(URL::to('/api/getMarketHistory/BTC_EUR')); ?>"><?php echo e(URL::to('/api/getMarketHistory/BTC_EUR')); ?></a>" 
                    ...
                    <div class="row pb-40">
                        <div class="col-lg-12 col-12">
                            <h2 class="title"><?php echo e(trans('app_lang.api_private')); ?></h2>
                            <p><?php echo e(trans('app_lang.api_privatecnt')); ?></p>
                            <br>
                                ...
                                <div class="card collapse-icon accordion-icon-rotate">
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#makeorder"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_makeorder')); ?></span></a>
                                    </div>
                                    <div id="makeorder" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_makeordercnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                    <?php echo e(URL::to('/api/createOrder')); ?></p>
                                                <br>
            ...
            "ordertype": "Limit"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#openbuyorder"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_openbuyorder')); ?></span></a>
                                    </div>
                                    <div id="openbuyorder" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_openbuyordercnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                  <?php echo e(URL::to('/api/openBuyorders')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
            ...
            "to_cur": "EUR"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#opensellorder"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_opensellorder')); ?></span></a>
                                    </div>
                                    <div id="opensellorder" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_opensellordercnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                   <?php echo e(URL::to('/api/openSellOrders')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>pair </span>(string) - BTC_EUR.
            ...
            "to_cur": "EUR"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#balance"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_accountbalance')); ?></span></a>
                                    </div>
                                    <div id="balance" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_accountbalancecnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                   <?php echo e(URL::to('/api/getAccountbalance')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
        ...
        "WAVES": 1000
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#curbalance"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_currencybalance')); ?></span></a>
                                    </div>
                                    <div id="curbalance" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_currencybalancecnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                    <?php echo e(URL::to('/api/getCurrencybalance')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
        ...
        "Available balance": "993.7"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#tradehistory"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_filledorders')); ?></span></a>
                                    </div>
                                    <div id="tradehistory" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_filledorderscnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                   <?php echo e(URL::to('/api/getFilledOrder')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>pair </span>(string) - BTC_EUR
            ...
            "buyordertype": "limit"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#deposit_history"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_deposithistory')); ?></span></a>
                                    </div>
                                    <div id="deposit_history" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_deposithistorycnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                    <?php echo e(URL::to('/api/getDeposithistory')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>No params </span>
            ...
            "type": "fiat"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#withdraw_history"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_withdrawhistory')); ?></span></a>
                                    </div>
                                    <div id="withdraw_history" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_withdrawhistorycnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                    <?php echo e(URL::to('/api/getWithdrawhistory')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>No params </span>
            ...
            "type": "crypto"
                                    ...
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#cancel_order"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_cancelorder')); ?></span></a>
                                    </div>
                                    <div id="cancel_order" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_cancelordercnt')); ?></p>
                                                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                                                    <?php echo e(URL::to('/api/closeOrder')); ?></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
    ...
    <div id="deposit_amnt" role="tabpanel" aria-labelledby="heading16" class="collapse">
        <div class="card-content">
            <div class="card-body">
                <p><?php echo e(trans('app_lang.api_cancelordercnt')); ?></p>
                <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                    <?php echo e(URL::to('/api/deposit')); ?></p>
                <br>
                <h4 class="h4">Parameters:</h4>
                <ul class="api-docs-ul-list">
                    <li><span>currency </span>(string) - BTC 
...
<div id="withdraw_amnt" role="tabpanel" aria-labelledby="heading17" class="collapse">
    <div class="card-content">
        <div class="card-body">
            ...
            <p class="round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">POST
                <?php echo e(URL::to('/api/withdraw')); ?></p>
            <br>
            <h4 class="h4">Parameters:</h4>
            <ul class="api-docs-ul-list">
               <ul class="api-docs-ul-list">
                    ...
                    <code>
{
    ...
    "message" : "Withdraw request placed successfully! Please confirm your email"
                    ...
                    <div class="row pb-40">
                        <div class="col-lg-12 col-12">
                            <h2 class="title"><?php echo e(trans('app_lang.api_public')); ?></h2>
                            <p><?php echo e(trans('app_lang.api_publiccnt')); ?></p>
                            <br>
                            <div class="api-docs-collapse" role="tablist" aria-multiselectable="true">
                                <div class="card collapse-icon accordion-icon-rotate">
                                    <div id="heading11" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#stats"
                                           aria-expanded="false"
                                           aria-controls="stats" class="card-title lead collapsed"><span class="gradient-color"><?php echo e(trans('app_lang.api_returnticker')); ?></span></a>
                                    </div>
                                    <div id="stats" role="tabpanel" aria-labelledby="heading11" class="collapse">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_returntickercnt')); ?></p>
                                                <p><a href="<?php echo e(URL::to('/api/returnTicker')); ?>"
                                                      class="btn round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">GET
                                                   <?php echo e(URL::to('/api/returnTicker')); ?></a></p>
                                                <br>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>No params</span>
                                    ...
                                    <div id="heading12" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#accordion12"
                                           ...
                                           aria-controls="accordion12" class="card-title lead collapsed"><span
                                                class="gradient-color"><?php echo e(trans('app_lang.api_getcurrency')); ?></span></a>
                                    </div>
                                    <div id="accordion12" role="tabpanel" aria-labelledby="heading12" class="collapse"
                                         aria-expanded="false">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_getcurrencycnt')); ?></p>
                                                <p><a href="<?php echo e(URL::to('/api/getCurrencies')); ?>"
                                                      class="btn round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">GET
                                                  <?php echo e(URL::to('/api/getCurrencies')); ?></a></p>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>No Params </span> 
                                                    </li>
                                    ...
                                    <div id="heading13" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#accordion13"
                                           ...
                                           aria-controls="accordion13" class="card-title lead collapsed"><span
                                                class="gradient-color"><?php echo e(trans('app_lang.api_orderbook')); ?></span></a>
                                    </div>
                                    <div id="accordion13" role="tabpanel" aria-labelledby="heading13" class="collapse"
                                         aria-expanded="false">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_orderbookcnt')); ?></p>
                                                <p><a href="<?php echo e(URL::to('/api/getOrderbook/BTC_EUR')); ?>"
                                                      class="btn round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">GET
                                                    <?php echo e(URL::to('/api/getOrderbook/BTC_EUR')); ?></a></p>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>pair </span>(string) - BTC_EUR
                                                    </li>
                                    ...
                                    <div id="heading14" class="card-header">
                                        <a data-toggle="collapse" data-parent="#accordionWrap1" href="#accordion14"
                                           ...
                                           aria-controls="accordion14" class="card-title lead collapsed"><span
                                                class="gradient-color"><?php echo e(trans('app_lang.api_markethistory')); ?></span></a>
                                    </div>
                                    <div id="accordion14" role="tabpanel" aria-labelledby="heading14" class="collapse"
                                         aria-expanded="false" style="height: 0px;">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <p><?php echo e(trans('app_lang.api_markethistorycnt')); ?></p>
                                                <p><a href="<?php echo e(URL::to('/api/getMarketHistory/BTC_EUR')); ?>"
                                                      class="btn round-theme-btn btn-teal btn-glow btn-lg box-shadow-2">GET
                                                    <?php echo e(URL::to('/api/getMarketHistory/BTC_EUR')); ?></a></p>
                                                <h4 class="h4">Parameters:</h4>
                                                <ul class="api-docs-ul-list">
                                                    <li><span>pair </span>(string) - BTC_EUR
                                                    </li>
