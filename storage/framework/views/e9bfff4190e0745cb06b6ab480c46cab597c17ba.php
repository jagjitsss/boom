  ...
  <div class="container ">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-lg-12 footer-top">
        ...
        <p class="text-center">
          <a  class="btn-primary" href="<?php echo e(url('/trade')); ?>">Trade Now</a>
          &nbsp;&nbsp;&nbsp;&nbsp;
           <?php 
      ...
      <?php echo $__env->make('front.common.subscriber', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <div class="col-md-2 col-sm-2 col-lg-2  wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
        ...
        <div class="footlks">
          ...
          <li><a href="<?php echo e($site->fb); ?>" target="_blank" >
            <i class="fa fa-facebook" aria-hidden="true"></i> Facebook
          </a></li>
          <li><a href="<?php echo e($site->twitter); ?>" target="_blank" >
            <i class="fa fa-twitter" aria-hidden="true"></i> Twitter
          </a></li>
          <li><a href="<?php echo e($site->gplus); ?>" target="_blank" >
            <i class="fa fa-instagram" aria-hidden="true"></i> Instagram
          </a></li>
          <li><a href="<?php echo e($site->linkedin); ?>" target="_blank" >
