      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 breadcrumb overview_tab"> <?php echo e(trans('app_lang.overview')); ?>
          ...
          <ul class="nav nav-tabs settings-tab">
            ...
            <li class="nav-item"> <a class="nav-link navt" href="<?php echo url('referral'); ?>"><?php echo e(trans('app_lang.invitation')); ?> →</a> </li>
          </ul>
        </div>
          ...
          <div class="row tab-pane active" id="my-profile">
		  		...
		  		<div class="col-md-12 col-sm-12 col-lg-12">
				  	<div class="row">
							...
							<div class="card-div-cnt dash-top-l dt1">
								...
								<div class="col-lg-12 col-12 api-docs-left">
									...
									<div class="pricechartBalance">
										<h1 id="text_price_euro_total">0.00<?php echo e($currency); ?></h1>
								...
								window.onload = function()
								{
									...
									var chart = new CanvasJS.Chart("chartContainer", {
										...
										axisY:
										{
											title: "",
											titleFontSize: 24,
											prefix: "<?php echo e($currency); ?>"
										},
										data: [{
											type: "line",
											yValueFormatString: "<?php echo e($currency); ?> #,##0.00",
									...
									function addData(data)
									{
										...
										var tots = data.total;
										$("#text_price_euro_total").html(tots+"<?php echo e($currency); ?>");
						...
						<div class="col-md-12 col-sm-6 col-lg-6">
						 ...
						 <h1 class="portbalanceH1 text-center"><?php echo e(number_format($estimateinr,2)); ?><?php echo e($currency); ?></h1>
                ...
                <div class="table-responsive col-md-12">
                  <table class="col-md-12">
                    ...
                    <?php $__currentLoopData = $portFolioList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="tr_border_here"> 
                      <td colspan="2"><img class="fixedWidthImg" src="<?php echo e(url('public/images/admin_currency')); ?>/<?php echo e($curr['img']); ?>"/> <?php echo e(ucfirst($curr['name'])); ?> </td>
                      <td  class="tdcols1here"><div class="td_cryptospan"> <?php echo e($curr['balance']); ?> <?php echo e($curr['symbol']); ?> </div>
                        <div class="td_fiatspan"><?php echo e(number_format($curr['amtvalue'], 4)); ?><?php echo e($currency); ?></div></td>
                    </tr>
				...
				<div class="col-md-12 col-sm-12 col-lg-12">
                  ...
                  <div class="table-responsive recent-activity-box">
                    <table>
                      ...
                      <?php $__currentLoopData = $deposit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dpst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo date("M",strtotime($dpst->updated_at)); ?> <br/>
                          <b><?php echo date("d", strtotime($dpst->updated_at)); ?></b></td>
                        <td><div class="dep-box">Deposit <br><?php echo e($dpst->currency); ?> <span> <?php echo e($dpst->amount); ?></span></div></td>
                        <td> <?php echo e($dpst->currency); ?> <br/>
						<b class="text-green"><?php echo e($dpst->status); ?></b> </td>
                      </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php $__currentLoopData = $fiatdeposit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fitdpst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo date("M",strtotime($fitdpst->updated_at)); ?> <br/>
                          <b><?php echo date("d", strtotime($fitdpst->updated_at)); ?></b></td>
                        <td><div class="dep-box">Deposit <br><?php echo e($fitdpst->currency); ?> <?php echo e($fitdpst->amount); ?></div></td>
                        <td> <?php echo e($fitdpst->currency); ?> <br/>
						<b class="text-green"><?php echo e($fitdpst->status); ?></b> </td>
                      </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
					 ...
					 <div class="text-center view-acc"><a href="<?php echo e(url('/funds')); ?>">View your accounts</a></div>
                </div>
					  	</div>
						<div class="col-md-12 col-sm-6 col-lg-6">
						<div class="card-div-cnt dash-top-l">
