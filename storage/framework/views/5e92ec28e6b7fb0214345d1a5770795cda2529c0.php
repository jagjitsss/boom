        ...
        <div class="tab-pane container no-padding active min-height-cnt" id="settings-profile">
            ...
            <div class="col-xs-12 col-sm-12 card-div">
                <div class="st-box">
                    ...
                    ?>
                    <!-- <li class="nav-item">
                      <a class="nav-link navtpr <?php if ($i == '') {echo 'active';}?>" data-toggle="tab" data-target="#my-profile" href="#my-profile"><?php echo e(trans('app_lang.my_profile')); ?></a> </li> -->

                      <li class="nav-item">
                        <a class="nav-link navt <?php if ($i == '') {echo 'active';}?>" data-toggle="tab"  data-target="#access"  href="#access"><?php echo e(trans('app_lang.access')); ?></a> </li>
                    ...
                    <li class="nav-item"> <a class="nav-link navt <?php if ($i == 'notification') {echo 'active';}?>" data-toggle="tab" <?php echo e($click); ?> data-target="<?php echo $session_name == ' ' ? ' ' : '#security' ?>" href="#security" id="security_link"><?php echo e(trans('app_lang.security')); ?></a> </li>
                    
                     <li class="nav-item"> <a class="nav-link navt <?php if ($i == 'notification') {echo 'active';}?>" data-toggle="tab" <?php echo e($click); ?> data-target="<?php echo $session_name == ' ' ? ' ' : '#apisecurity' ?>" href="#apisecurity" id="">API</a> </li>
                    
                      <li class="nav-item"> <a class="nav-link navt <?php if ($i == 'notification') {echo 'active';}?>" data-toggle="tab" <?php echo e($click); ?> data-target="<?php echo $session_name == ' ' ? ' ' : '#defaultcurrency' ?>" href="#defaultcurrency" id="">Currency</a> </li>
