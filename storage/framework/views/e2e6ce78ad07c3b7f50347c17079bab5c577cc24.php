<div class="dropdown-menu dropdown-menu1 dd-table-cnt">
		<div class="dd-table">
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link tab-pane-trade site_tet" data-toggle="tab" data-target="#dd-trade-fav" href="javascript:;"><?php echo e(trans('app_lang.favorite')); ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link active tab-pane-trade site_tet" data-toggle="tab" data-target="#dd-trade-btc" href="javascript:;">BTC</a>
				</li>
		
				<input type="text" placeholder="<?php echo e(trans('app_lang.search')); ?>" class="adv_search portlet-header-search" style="color:white;">
			</ul>
						...
						<table class="table table-hover table-borderless market-table adv-market">
							<thead>
							  <tr>
								...
								<th><?php echo e(trans('app_lang.pair')); ?></th>
								<th><?php echo e(trans('app_lang.price')); ?></th>
								<th>24h <?php echo e(trans('app_lang.change')); ?></th>
								<th>24h <?php echo e(trans('app_lang.volume')); ?></th>
							  </tr>
							</thead>
