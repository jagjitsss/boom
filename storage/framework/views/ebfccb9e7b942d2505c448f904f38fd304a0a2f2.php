...
<div class="header-section">
  <div class="container index-navigation px-0">
    ...
    <nav class="navbar navbar-expand-md justify-content-center index-header navbar-fixed-top"> <a class="navbar-brand" href="<?php echo Config::get('domain.url'); ?>"> 
      <img src="<?php echo e($site->site_logo); ?>" class="img-fluid"></a>
      ...
      <div class="container-fluid cf-main">
        <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2">
          ...
          <li class="nav-item"> <a class="nav-link" href="<?php echo url('api/api_document'); ?>" id="overview-link"> <?php echo e(trans('app_lang.api')); ?></a> </li>
            ...
            <li class="nav-item"> <a class="nav-link  " href="<?php echo e(url('/trade')); ?>"> Trade </a> </li>
            <li class="nav-item"> <a class="nav-link" href="<?php echo e(url('/funds')); ?>">Wallet</a> </li>


            <li class="nav-item d-flex"> 
              <div class="signin-btn d-flex">
                <a class="nav-link index-header-link nav-register" href="<?php echo url('register'); ?>"><?php echo e(trans('app_lang.signup')); ?></a> 
                <span>/</span> 
                <a class="nav-link index-header-link" href="<?php echo url('login'); ?>"><?php echo e(trans('app_lang.login')); ?></a> 
              </div>
            </li>
            ...
            <li class="nav-item dashboard-header-links">
              <div class="dropdown right-dd">
                ...
                <div class="header-profile-icon">
                  <?php
                  if ($user_profile == '') {?>
                  <img src="<?php echo e(asset('/').('public/assets/images/')); ?>avatar.png" class="header-profile-icon img-fluid">
                  <?php } else {?>
                  <img src="<?php echo e($user_profile); ?>" class="header-profile-icon img-fluid">
                  <?php }?>
                </div>
                </button>
                <div class="dropdown-menu">
                  ...
                  <ul>
                    <li class="drop_new_blk"> <a class="dropdown-item" href="<?php echo url('dashboard'); ?>"> <img src="<?php echo e(asset('/').('public/assets/images/')); ?>men_img.png" class="img-fluid"> <?php echo e(trans('app_lang.dashboard')); ?></a> </li>
                  </ul>
                </div>
              </div>
            </li>
