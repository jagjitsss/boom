...
<div class="col-xs-12 col-sm-12">
 ...
 <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane container-fluid no-padding active mb-3" id="defaultcurrencyhistory">
        <div class="row">
          <div class="col-xs-12 col-sm-12 dsb-acc-status-cnt pad_zero">
            ...
            <?php echo Form::open(array('id'=>'defaultCurrencyForm','url'=>'choose-currency','method'=>'POST','class'=>'d-flex')); ?>
    ...
    <div class="card-div tab-content col-xs-12 col-sm-12 no-padding">
      <div class="tab-pane container-fluid no-padding active mb-3" id="apihistory">
        <div class="row">
          <div class="col-xs-12 col-sm-12 dsb-acc-status-cnt pad_zero">
              <div class="card-div-cnt">
                <div class="dsb-acc-status-heading"><?php echo e(trans('app_lang.api_key')); ?>
              ...
              <div class="google_auth">
                <img class="img_new_class" src="<?php echo e(asset('/').('public/assets/images/')); ?>apikey12.png">
                <span>
                                 <?php echo e(trans('app_lang.enable_api')); ?></span>
                <p class="safecommon-text"> <?php echo e(trans('app_lang.access_api')); ?></p>
              ...
              <div class="google_auth">
                <span>
                                 <?php echo e(trans('app_lang.api_key')); ?></span>
                <p class="safecommon-text">
                                <input name="api_key" type="text" placeholder="First Name" class="profile-txtbox" value="<?php echo e($user->api_key); ?>" required="" disabled>
                 </p>
              </div>
              <div class="google_auth">
                <span>
                                 <?php echo e(trans('app_lang.api_secret')); ?></span>
                <p class="safecommon-text"> 
                                <input name="api_secretkey" type="text" placeholder="First Name" class="profile-txtbox" value="<?php echo e($user->api_secret); ?>" required="" disabled>
                </p>
              </div>
               <?php  } ?>
            </div>
                ...
                <table id="login_notification" class="table table-hover table-borderless" style="width: 100%">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('app_lang.ip_address')); ?></th>
                      <th><?php echo e(trans('app_lang.browser')); ?></th>
                      <th><?php echo e(trans('app_lang.date_time')); ?></th>
                      <th><?php echo e(trans('app_lang.location')); ?></th>
                    </tr>
                  </thead>
                </table>
              </div>
  ...
  <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab2">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 card-div align-self-stretch xl-p-r lg-p-r"> <?php echo Form::open(array('id'=>'edittfa','url'=>'updatetfa','method'=>'POST','class'=>'d-flex')); ?>

        <div class="card-div-cnt align-self-stretch d-flex">
          <div class="row security-qr-cnt">
            <div class="col-xs-12 col-sm-12 setting-security-heading"><?php echo e(trans('app_lang.TFA')); ?></div>
            ...
            ?>
            <div class="qr-cnt"><img src="<?php echo e($tfa_url); ?>" style=""></div>
            <div class="col-xs-12 col-sm-12 security-qr-value"><?php echo e($secret); ?></div>
            <?php }?>
            <div class="upload-prof-pic">
              <div class="google-auth-cnt"><span><?php echo e(trans('app_lang.GAC')); ?><a style="color: red">*</a></span> </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 profile-txt-box-cnt">
              <input type="text" name="onecode" placeholder="<?php echo e(trans('app_lang.6_digit_code')); ?>" class="profile-txtbox">
      ...
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 card-div align-self-stretch xl-p-l xl-p-r lg-p-r lg-p-l md-p-r"> <?php echo Form::open(array('id'=>'change_password','url'=>'updatePassword','method'=>'POST','class'=>'d-flex')); ?>

        <div class="card-div-cnt settings-security-cnt-height d-flex flex-column">
          <div class="row security-qr-cnt">
            <div class="col-xs-12 col-sm-12 setting-security-heading"><?php echo e(trans('app_lang.change_password')); ?></div>
            <div class="col-xs-12 col-sm-12 col-md-12 profile-txt-box-cnt">
              ...
              <input type="password" name="oldpassword" placeholder="<?php echo e(trans('app_lang.current_password')); ?>" class="profile-txtbox">
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 profile-txt-box-cnt">
          ...
          <div class="btn-cnt abs-btn-cnt mt-auto">
            <button type="submit" class="dsb-blue-btn"><?php echo e(trans('app_lang.update_password')); ?></button>
          </div>
        </div>
        <?php echo Form::close(); ?> </div>
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 card-div align-self-stretch xl-p-l lg-p-l md-p-l">
        <div class="card-div-cnt settings-security-cnt-height">
          <div class="row">
            <div class="col-xs-12 col-sm-12 setting-security-heading"><?php echo e(trans('app_lang.notification')); ?></div>
            <div class="col-xs-12 col-sm-12 setting-security-subheading"><?php echo e(trans('app_lang.request_email_notf')); ?></div>
            <div class="col-xs-12 col-sm-12 security-notif-row-cnt">
              <div class="col-xs-12 col-sm-12 security-notif-row d-flex"> <span><?php echo e(trans('app_lang.2fa')); ?></span>
                <label class="switch ml-auto">
                  <input type="checkbox" <?php echo $user->tfa ? 'checked' : ''; ?> onclick="notification('2fa')">
                  <span class="slider round"></span> </label>
              </div>
              <div class="col-xs-12 col-sm-12 security-notif-row d-flex"> <span><?php echo e(trans('app_lang.for_change_password')); ?></span>
                <label class="switch ml-auto">
                  <input type="checkbox" <?php echo $user->change_password ? 'checked' : ''; ?>  onclick="notification('password')">
                  <span class="slider round"></span> </label>
              </div>
              <div class="col-xs-12 col-sm-12 security-notif-row d-flex"> <span><?php echo e(trans('app_lang.for_new_device')); ?></span>
                <label class="switch ml-auto">
      ...
      <div class="col-xs-12 col-sm-12 card-div">
        <div class="card-div-cnt settings-tab-cnt">
          <ul class="nav nav-tabs settings-tab">
            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" data-target="#notify" href="#"><?php echo e(trans('app_lang.notification')); ?></a> </li>
          </ul>
        </div>
      </div>
                ...
                <div class="table-responsive dsb-wallet-table notify-table">
                  <table class="table table-hover table-borderless">
                    <thead>
                      <tr>
                        <th class="table-sno-cnt">#</th>
                        <th><?php echo e(trans('app_lang.content')); ?></th>
                        <th><?php echo e(trans('app_lang.date_time')); ?></th>
                      </tr>
                    </thead>
...
<script>
  ...
  var current_pwd_chp ="<?php echo e(trans('app_lang.curr_min_8_char_validate')); ?>";
  var new_pwd_chp ="<?php echo e(trans('app_lang.min_8_char_validate')); ?>";
  var same_pwd_chp ="<?php echo e(trans('app_lang.enter_same_password')); ?>";
  var cur_pwdmin_chp ="<?php echo e(trans('app_lang.current_pwd_min_8_char')); ?>";
  var new_pwdmin_chp ="<?php echo e(trans('app_lang.min_8_char')); ?>";


  var success_notfy ="<?php echo e(trans('app_lang.notification_update')); ?>";
  var success_notfy_dis ="<?php echo e(trans('app_lang.notification_update_dis')); ?>";

  var error_notfy ="<?php echo e(trans('app_lang.please_try_again')); ?>";

  var trade_msg    = "<?php echo e(trans('app_lang.trade_msg')); ?>";
  var tfa_msg      = "<?php echo e(trans('app_lang.tfa_msg')); ?>";
  var password_msg = "<?php echo e(trans('app_lang.pwd_msg')); ?>";
  var device_msg   = "<?php echo e(trans('app_lang.device_msg')); ?>";


   var min_3_prof        = "<?php echo e(trans('app_lang.coin_min_3')); ?>";
   var max_15_prof       = "<?php echo e(trans('app_lang.limit_15_char')); ?>";
   var letter_space_prof = "<?php echo e(trans('app_lang.letter_space_allowed')); ?>";
   var min_5_prof        = "<?php echo e(trans('app_lang.min_5_char')); ?>";
   var valid_no_prof     = "<?php echo e(trans('app_lang.valid_number')); ?>";
   var min_6_mob_prof     = "<?php echo e(trans('app_lang.min_6_digits')); ?>";
   var max_12_mob_prof     = "<?php echo e(trans('app_lang.max_12_digits')); ?>";
   var files_prof          = "<?php echo e(trans('app_lang.only_files')); ?>";
