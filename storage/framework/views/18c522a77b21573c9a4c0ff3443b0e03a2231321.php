	...
	<div class="loader-bg" id="load">
		...
		<nav class="navbar navbar-expand-md justify-content-center index-header dashboard-header">
			...
			<a class="navbar-brand" href="<?php echo Config::get('domain.url'); ?>">
				...
				<img id="tlogo" src="<?php echo e($site->site_logo); ?>" class="img-fluid tlogo">
			</a>
			</a>
								...
								<div class="dropdown exc-dd">
								  ...
								  <div class="dropdown-menu">
								   <?php $__currentLoopData = $pairs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								  	<a class="dropdown-item" href="<?php echo e(url('trade')); ?>/<?php echo e($pair->to_symbol); ?>_<?php echo e($pair->from_symbol); ?>"><?php echo e($pair->to_symbol); ?>/<?php echo e($pair->from_symbol); ?></a>
								...
								<div class="exc-data-container">
									<div class="d-flex exc-data-m">
										...
										<div class="exc-data-inn exc-data-inn-last">
											...
											<div class="exc-data-cnt">
												<span class="lgtxt">24h <?php echo e(trans('app_lang.volume')); ?>  (<span class="to_cur"></span>)</span>
												<span class="volume"></span>
											</div>
										</div>
									</div>
						...
						<ul class="nav navbar-nav flex-row justify-content-center flex-nowrap right-nav-links dsb-header-tab">
							...
							<?php if (Session::has('tmaitb_user_id')) {
								...
								<li class="nav-item notify_msg">
										...
										<div class="notify-content">
											...
											<li class="nav-item dashboard-header-links dash-header-icon-link">
												<div class="dropdown">
													...
													<a href="<?php echo e(url('/notification_list')); ?>" onclick="view_notf('<?php echo $p; ?>')"><button  class="profile-dd dropdown-toggle" style="cursor: pointer">
									...
									<a href="javascript:;" onclick="change_theme('dark')"><img id="lighticon" src="<?php echo e(asset('/').('public/assets/images/')); ?>light_bg.png" class="img-fluid"></a>
									<a href="javascript:;" onclick="change_theme('light')"><img id="darkicon" src="<?php echo e(asset('/').('public/assets/images/')); ?>dark_bg.png" class="img-fluid"></a>
								</div>	
																</li>
												<?php } else {?>
												<li class="nav-item">
												...
												<li class="nav-item">
													<a class="nav-link dashboard-header-links dash-header-icon-link dash-header-txt-link index-header-link nav-register" href="<?php echo url('register'); ?>"><?php echo e(trans('app_lang.signup')); ?></a>
												</li>
...
<?php }?>
												...
												<div class="trade_container">
													<div class="">
														...
														<?php echo $__env->make($viewsource, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
															...
															<script src="<?php echo e(asset('/').('public/assets/js/tradescript.js')); ?>?<?php echo e(date('Y-m-d h:i:s')); ?>"></script>
															<script>
																setTimeout(function () {
    ...
    $(document).ready(function() {
    	...
    	displayChart('<?php echo e($pair_symbol); ?>');
    	showBalance();
    	showMarket();
