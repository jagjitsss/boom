...
<a class="navbar-brand" href="<?php echo Config::get('domain.url'); ?>">
	<img src="{{$site->tradesite_logo}}" class="img-fluid mobile-logo">
</a>
...
<div class="container-fluid">
	<div class="navbar-collapse collapse justify-content-between align-items-center w-100 adv-theme-header" id="collapsingNavbar2">
		...
		<ul class="navbar-nav col-sm-12 no-padding center-nav-links adv-li">
			<a class="navbar-brand" href="<?php echo Config::get('domain.url'); ?>">
				<img src="{{$site->tradesite_logo}}" class="img-fluid device-logo">
			</a>
			<div class="ad_top_new_link">
				<?php if (Session::has('tmaitb_user_id'))
				{ ?>
					<li>
						<a class="nav-link <?php echo $page == 1 ? 'active' : ' ' ?>" href="<?php echo url('dashboard'); ?>" id="exchange-link">{{trans('app_lang.overview') }}</a>
					</li>
		          ...
		          <li class="nav-item">
					...
					<li>
						<a class="nav-link <?php echo $page == 3 ? 'active' : ' ' ?>" href="<?php echo url('funds'); ?>" id="exchange-link">{{trans('app_lang.funds') }}</a>
					</li>
					<li>
						<a class="nav-link <?php echo $page == 4 ? 'active' : ' ' ?>" href="<?php echo url('referral'); ?>" id="exchange-link">{{trans('app_lang.refer') }}</a>
					</li>
					<li style="display:none;">
						<a class="nav-link <?php echo $page == 5 ? 'active' : ' ' ?>" href="<?php echo url('addCoins'); ?>" id="exchange-link">{{trans('app_lang.add_coin') }}</a>
					</li>
					<li>
						<a class="nav-link <?php echo $page == 6 ? 'active' : ' ' ?>" href="<?php echo url('support'); ?>" id="exchange-link">{{trans('app_lang.support') }}</a>
					</li>
					<li><a class="nav-link <?php echo $page == 7 ? 'active' : ' ' ?>" href="<?php echo url('bankwire/USD'); ?>" id="exchange-link">{{trans('app_lang.bankwire') }}</a></li>
				<?php } else { ?>
...
<?php if (!$log) {?>
		...
		<li class="nav-item">
			...
			<a class="nav-link dashboard-header-links dash-header-icon-link dash-header-txt-link index-header-link nav-register" href="<?php echo url('register'); ?>" style="color:white;">{{trans('app_lang.signup') }}</a>
		</li>
...
<?php if (Session::has('tmaitb_user_id')) {?>
			...
			<div class="dropdown exc-dd dropdown coinDrop"><img style="width: 25px; height: 25px;" src="{{asset('/').('public/assets/images/')}}bitcoin-icon.png">
			  <button type="button" class="exc-topbar-dd dropdown-toggle">
				<span class="exc-dd-heading cur_pair"></span>
			  </button>
			   @include('front/advance_trade/popup-advanced')
