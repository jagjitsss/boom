		...
		<div class="portlet mob-inn1">
			<div class="portlet-header">
				<ul class="nav nav-tabs d-flex">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" data-target="#trade-myorder" href="javascript:;">{{trans('app_lang.open_orders') }}</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" data-target="#stoporder" href="javascript:;">{{trans('app_lang.stop_orders') }}</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" data-target="#trade-history" href="javascript:;">{{trans('app_lang.trade_history') }}</a>
					</li>
				</ul>
			</div>
							...
							<table class="table table-hover table-borderless market-table">
								<thead>
								  <tr>
										...
										<th>{{trans('app_lang.amount') }}(<span class="to_cur"></span>)</th>
										<th>{{trans('app_lang.price') }}(<span class="from_cur"></span>)</th>
										<th>{{trans('app_lang.price_stop') }}(<span class="from_cur"></span>)</th>
										<th>{{trans('app_lang.total') }}(<span class="from_cur"></span>)</th>
    ...
    <div class="portlet-header ul-buy-sell d-flex">
	  ...
	  <ul class="nav nav-tabs d-flex">
        ...
        <li class="ul_li_buy nav-item"> 
        	<a id="ul_li_buy_a_limit" class="nav-link advbuylimit show active" data-toggle="tab" data-target="#advtrade-limit" onclick="show_adv_order('limit','buy')"   href="javascript:;">{{trans('app_lang.limit') }}</a>
        </li>
        ...
        <li class="ul_li_sell nav-item" style="display: none;"> 
        	<a id="ul_li_sell_a_limit" class="nav-link advbuylimit show active" data-toggle="tab" data-target="#advtrade-limit" onclick="show_adv_order('limit','sell')"   href="javascript:;">{{trans('app_lang.limit') }}</a>
        </li>
        
        <li class="ul_li_sell nav-item" style="display: none;">
        	<a class="nav-link advbuyform" data-toggle="tab" data-target="#advtrade-limit" onclick="show_adv_order('market','sell')"   href="javascript:;">{{trans('app_lang.market') }}</a>
        </li>
        
        <li class="ul_li_sell nav-item" style="display: none;">
        	<a class="nav-link advbuyform" data-toggle="tab" data-target="#advtrade-limit" onclick="show_adv_order('stop','sell')"   href="javascript:;">{{trans('app_lang.stop_limit') }}</a>
        </li>
        ...
        <div class="tab-pane container active" id="advtrade-order">
          ...
          <div id="basic_buy_trade_parent" class="adv-buycnt adv-buycnt-full">
            <div class="table-responsive">
              ...
              <div class="portlet-txtbox-cnt d-flex">
                ...
                <input id="input_one" type="text" onkeyup="calculation('buy');"  class="amount buyamount" placeholder="{{trans('app_lang.amount') }}" onkeypress="return isNumberKey(event)" >
              ...
              <div class="portlet-txtbox-cnt d-flex">
                ...
                <input  id="input_two" type="text" onkeyup="calculation('buy');"  class="price buyprice" placeholder="{{trans('app_lang.price') }}" onkeypress="return isNumberKey(event)">
				<span class="plus-one">
              ...
              <div id="stop_buy_section" class="portlet-txtbox-cnt stop buystop hide d-flex" style="display: none !important;">
                ...
                <input id="input_three" type="text" onkeyup="calculation('buy');" class="buystopprice" placeholder="{{trans('app_lang.price_stop') }}" onkeyup="calculation('buy');"  onkeypress="return isNumberKey(event)" >
             ...
             <div class="clearfix"></div>
			  <div class="d-flex full-md-total">
			 	<div class="full-wd-info-cnt nomarket"> {{trans('app_lang.total') }}<span>
                ...
                <?php } else { ?>
                <button type="button" class="buybtn" onclick="return order_placed('buy',this)" >{{trans('app_lang.buy') }}</button>
                <?php } } else { ?>
                <p class="b4login-p"><a class="green-link" href="<?php echo url('login'); ?>">{{trans('app_lang.login') }}</a>
                  <?php } ?>
              </div>
			 </div> 
			</div>
          ...
          <div id="basic_sell_trade_parent" class="adv-sellcnt adv-sellcnt-full">
            ...
            <div class="portlet-txtbox-cnt d-flex">
              ...
              <input id="input_four" type="text" onkeyup="calculation('sell');" placeholder="{{trans('app_lang.amount') }}" class="amount sellamount" onkeypress="return isNumberKey(event)" >
            ...
            <div class="portlet-txtbox-cnt d-flex">
              ...
              <input id="input_five" type="text" onkeyup="calculation('sell');" placeholder="{{trans('app_lang.price') }}" class="sellprice price" onkeypress="return isNumberKey(event)" >
            ...
            <div id="stop_sell_section" class="portlet-txtbox-cnt stop sellstop hide d-flex" style="display: none!important;">
              ...
              <input id="input_six" type="text" onkeyup="calculation('sell');" class="sellstopprice" placeholder="{{trans('app_lang.price_stop') }}" onkeyup="calculation('sell');"  onkeypress="return isNumberKey(event)" >
            ...
            <div class="clearfix"></div>
			<div class="d-flex full-md-total">
			<div class="full-wd-info-cnt nomarket"> {{trans('app_lang.total') }}<span><span class="tot selltot">0.00000000 </span> <span class="from_cur"></span></span> </div>
            <div class="portlet-btn-cnt">
              ...
              <?php } else { ?>
              <button type="button"  onclick="return order_placed('sell',this)"  class="portlet-red-btn sellbtn">{{trans('app_lang.sell') }}</button>
              <?php } } else { ?>
              <p class="b4login-p"><a class="green-link" href="<?php echo url('login'); ?>">{{trans('app_lang.login') }}</a>
                <?php } ?>
            </div>
