...
<html lang="en">
  ...
  <link href="{{asset('/').('public/assets/css/fileinput.css')}}" rel="stylesheet" type="text/css">
  ...
  <link rel="stylesheet" href="{{asset('/').('public/assets/css/')}}dataTables.bootstrap4.min.css" type="text/css">
  <link rel="stylesheet" href="{{asset('/').('public/assets/css/')}}jquery.dataTables.min.css" type="text/css">
  <link rel="stylesheet" href="{{asset('/').('public/assets/css/')}}responsive.dataTables.min.css" type="text/css">
  <link rel="stylesheet" href="{{asset('/').('public/assets/css/')}}chosen.css"  type="text/css">
...
<div class="loader-bg" id="load">
  <div class="loader"> 
    <img src="{{asset('/').('public/assets/images/')}}loader.gif" >
  </div>
  </div>
  ...
  <nav class="navbar navbar-expand-md justify-content-center index-header dashboard-header"> 
    <a class="navbar-brand" href="<?php echo Config::get('domain.url'); ?>">
      <img src="{{$site->site_logo}}"class="img-fluid">
    </a>
    ...
    <div class=" "> 
        ...
        <div class="container">
          <ul class="inner-sec-menu">
            ...
            <li><a href="<?php echo url('/editprofile'); ?>" class="active"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a></li>

            <li><a href="<?php echo url('/profile'); ?>" class=""><i class="fa fa-user" aria-hidden="true"></i>Profile</a></li>
        ...
        <div class="tab-pane container no-padding active min-height-cnt" id="settings-profile">
            ...
            <div class="col-xs-12 col-sm-12 card-div">
                <div class="st-box">
                    ...
                    <?php
                    $i = app('request')->input('name');
                    ?>
                    <!-- <li class="nav-item">
                      <a class="nav-link navtpr <?php if ($i == '') {echo 'active';}?>" data-toggle="tab" data-target="#my-profile" href="#my-profile">{{trans('app_lang.my_profile') }}</a> </li> -->

                      <li class="nav-item">
                        <a class="nav-link navt <?php if ($i == '') {echo 'active';}?>" data-toggle="tab"  data-target="#access"  href="#access">{{trans('app_lang.access') }}</a> </li>

                    <?php
                    if ($session_name == ' ') {
                      $click = 'onclick=shownotify()';
                    } else {
                      $click = '';
                    }
                    ?>
                    
                    <li class="nav-item"> <a class="nav-link navt <?php if ($i == 'notification') {echo 'active';}?>" data-toggle="tab" {{$click}} data-target="<?php echo $session_name == ' ' ? ' ' : '#security' ?>" href="#security" id="security_link">{{trans('app_lang.security') }}</a> </li>
                    
                     <li class="nav-item"> <a class="nav-link navt <?php if ($i == 'notification') {echo 'active';}?>" data-toggle="tab" {{$click}} data-target="<?php echo $session_name == ' ' ? ' ' : '#apisecurity' ?>" href="#apisecurity" id="">API</a> </li>
                    
                      <li class="nav-item"> <a class="nav-link navt <?php if ($i == 'notification') {echo 'active';}?>" data-toggle="tab" {{$click}} data-target="<?php echo $session_name == ' ' ? ' ' : '#defaultcurrency' ?>" href="#defaultcurrency" id="">Currency</a> </li>

                  </ul>
              </div>
              </div>
            @include($vieweditsource) </div>
          </div>
        @endif
...
<script src="{{asset('/').('public/assets/js/fileinput.js')}}"></script> 
...
<script src="{{asset('/').('public/assets/js/diacritics.js')}}"></script> 
<script src="{{asset('/').('public/assets/js/bootstrap-dropdown-filter.js')}}"></script> 

<script src="{{asset('/').('public/assets/js/')}}buttons.html5.min.js"></script> 
<script src="{{asset('/').('public/assets/js/')}}chosen.jquery.js"></script> 
...
<script src="{{asset('/').('public/assets/js/common_script.js')}}?{{date('Y-m-d h:i:s')}}"></script> 
<script type="text/javascript">
...
<script src="{{asset('/').('public/assets/js/transaction_script.js')}}?{{date('Y-m-d h:i:s')}}"></script> 
<script>
setTimeout(function () {
...
<script>
var only_files_allow = "{{ trans('app_lang.only_files') }}";
var profile_details  = "{{ trans('app_lang.fill_your_profile_details') }}";
...
function checkKyc(){
	...
	window.location.href = "{{URL::to('/dashboard?name=verification')}}";
