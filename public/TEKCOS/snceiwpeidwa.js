...
var boomcPrice = require('./boomcPrice');
...
app.get('/generateNewTokenAddress', function(req, res)
{
    ...
    res.json({ data: newToken, message:'live' });
});
...
/*app.get('/sendBNBtokennew', function(req, res)
{	
    var resdata = sendBNBtoken.sendBNBtoken(req, res);
...
{	
	...
	res.json({ data: "route access >>>" });
});


app.post('/boomcPrice', function(req, res)
{	
	var data = req.body;
    var resdata = boomcPrice.boomcPrice(data, res);
